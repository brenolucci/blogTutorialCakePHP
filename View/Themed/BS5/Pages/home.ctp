            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <?= $this->Html->link(__('Saiba mais %s', '<i class="fas fa-arrow-circle-right"></i>'), [
                            'controller' => 'posts',
                            'action' => 'index',
                        ], [
                        ...
                        <div class="card-body">
                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    ...
                                    <div class="image">
                                        <?= $this->Html->image('user1-128x128.jpg', [
                                ...
                                <div class="direct-chat-msg right">
                                    ...
                                    <?= $this->Html->image('user3-128x128.jpg', [
                            ...
                            <div class="direct-chat-contacts">
                                <ul class="contacts-list">
                                    ...
                                    <li>
                                        <a href="#">
                                            <?= $this->Html->image('user7-128x128.jpg', [
                                    ...
                                    <li>
                                        <a href="#">
                                            <?= $this->Html->image('user5-128x128.jpg', [
                                                'class' => 'contacts-list-img',
                                                'alt' => __('User Avatar'),
                                            ]) ?>
                                            <div class="contacts-list-info">
                                    ...
                                    <li>
                                        <a href="#">
                                            <?= $this->Html->image('user6-128x128.jpg', [
                                                'class' => 'contacts-list-img',
                                                'alt' => __('User Avatar'),
                                            ]) ?>
                                            <div class="contacts-list-info">
                                    ...
                                    <li>
                                        <a href="#">
                                            <?= $this->Html->image('user8-128x128.jpg', [
                                                'class' => 'contacts-list-img',
                                                'alt' => __('User Avatar'),
                                            ]) ?>
                                            <div class="contacts-list-info">
